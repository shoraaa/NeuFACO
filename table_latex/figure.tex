...
\newcolumntype{M}[1]{>{$}c<{$}} % cột toán học cho N
...
\begin{tabular}{c M{1.5cm} C{0.8cm} cc cc cc}
\toprule[1pt]
&  &  & \multicolumn{2}{c}{DeepACO} & \multicolumn{2}{c}{GFACS} & \multicolumn{2}{c}{NeuFACO} \\
\cmidrule(lr){4-5}\cmidrule(lr){6-7}\cmidrule(lr){8-9}
\multirow{-2}{*}{\makecell[c]{Dataset}} &
\multirow{-2}{*}{\makecell[c]{N}} &
...
\multirow{3}{*}{\makecell[c]{TSP \\ Random}}
  & 200  & 64 & 1.89 & 16.86  & 1.80 & 17.36  & \textbf{1.66} & \textbf{0.28} \\
  & 500  & 64 & 3.03 & 119.58 & 1.54 & 136.14 & \textbf{1.50} & \textbf{0.74} \\
  & 1000 & 32 & 4.44 & 652.46 & 2.57 & 731.17 & \textbf{2.19} & \textbf{1.98} \\
\bottomrule[1pt]
\end{tabular}
\end{table}
...
% TSPLib200 – NeuFACO → Avg gap: 1.39%, Avg time: 0.22s
% TSPLib500 – DeepACO → Avg gap: 3.43%, Avg time: 143.92s
% TSPLib500 – GFACS → Avg gap: 2.46%, Avg time: 150.49s
% TSPLib500 – NeuFACO → Avg gap: 2.06%, Avg time: 0.48s
% TSPLib1000 – DeepACO → Avg gap: 4.86%, Avg time: 1047.59s
% TSPLib1000 – GFACS → Avg gap: 3.99%, Avg time: 1141.24s
% TSPLib1000 – NeuFACO → Avg gap: 2.98%, Avg time: 1.03s

% % TSPRandom
% TSPRand200 – DeepACO → Avg gap: 1.89%, Avg time: 16.86s
% TSPRand200 – GFACS → Avg gap: 1.80%, Avg time: 17.36s
% TSPRand200 – NeuFACO → Avg gap: 1.66%, Avg time: 0.28s
% TSPRand500 – DeepACO → Avg gap: 3.03%, Avg time: 119.58s
% TSPRand500 – GFACS → Avg gap: 1.54%, Avg time: 136.14s
% TSPRand500 – NeuFACO → Avg gap: 1.50%, Avg time: 0.74s
% TSPRand1000 – DeepACO → Avg gap: 4.44%, Avg time: 652.46s
% TSPRand1000 – GFACS → Avg gap: 2.57%, Avg time: 731.17s
% TSPRand1000 – NeuFACO → Avg gap: 2.19%, Avg time: 1.98s
...
Method & Gap(\%) & Time & Gap(\%) & Time & Gap(\%) & Time \\
\midrule[1pt]
DeepACO    & 1.89 & 16.86s  & 3.03 & 119.58s  & 4.44 & 652.46s \\
GFACS      & 1.80 & 17.36s  & 1.54 & 136.14s  & 2.57 & 731.17s \\
NeuFACO    & \textbf{1.66} & \textbf{0.28s}  & \textbf{1.50} & \textbf{0.74s}  & \textbf{2.19} & \textbf{1.98s} \\
\bottomrule[1pt]
\end{tabular}
\end{minipage}
\end{table}
...
NeuFACO            & \textbf{16.38} & \textbf{1.52} & 32.6s
