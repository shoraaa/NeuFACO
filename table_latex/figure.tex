...
Pointerformer      & 17.14 & 3.56  & 14s  & 24.80 & 7.90  & 40s \\
\cmidrule(lr){1-1}\cmidrule(lr){2-4}\cmidrule(lr){5-7}
H-TSP (AAAI 2023)             & 17.55 & 6.22  & 23s  & 24.65 & 6.62  & 0.33s\\
GLOP  (AAAI 2024)             & -- &   &   & -- & 2.85  & 10.2s\\
ELG   (IJCAI 2024)            & -- &   &   & -- & 11.33  & 0.8s\\
INViT-3V+greedy(ICML 2024)    & -- &   &   & -- & 6.66  & 9s\\
UDC(NeurIPS 2024)             & -- &   &   & -- & 1.7  & 84s\\
SIT+Greedy                    & -- &   &   & -- & 1.95  & 0.2s\\
\cmidrule(lr){1-1}\cmidrule(lr){2-4}\cmidrule(lr){5-7}
DeepACO            & 16.84 & 1.77 & 15s & 23.78 & 2.87 & 66s \\
