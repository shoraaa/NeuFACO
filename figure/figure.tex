...
\hline
% \multirow{3}{*}{\rotatebox[origin=c]{90}{\scalebox{0.8}{TSPLib}}}
\multirow{3}{*}{\rotatebox[origin=c]{0}{\scalebox{0.8}{\makecell{TSP \\ Lib}}}}
& 100--299  & 30 &\makecell{2670 \\ (3.53\%)} & \makecell{2670 \\ (3.53\%)} & \textbf{\makecell{2670 \\ (3.53\%)}} \\
& 300--699  & 10 &\makecell{2670 \\ (3.53\%)} & \makecell{2670 \\ (3.53\%)} & \textbf{\makecell{2670 \\ (3.53\%)}} \\
& 700--1499 & 12 &\makecell{2670 \\ (3.53\%)} & \makecell{2670 \\ (3.53\%)} & \textbf{\makecell{2670 \\ (3.53\%)}} \\
\Xhline{0.8pt}
\multirow{3}{*}{\rotatebox[origin=c]{0}{\scalebox{0.8}{\makecell{TSP \\ Random}}}}
& 200  & 10 &\makecell{2670 \\ (3.53\%)} & \makecell{2670 \\ (3.53\%)} & \textbf{\makecell{2670 \\ (3.53\%)}} \\
& 500  & 10 &\makecell{2670 \\ (3.53\%)} & \makecell{2670 \\ (3.53\%)} & \textbf{\makecell{2670 \\ (3.53\%)}} \\
& 1000 & 128 &\makecell{2670 \\ (3.53\%)} & \makecell{2670 \\ (3.53\%)} & \textbf{\makecell{2670 \\ (3.53\%)}} \\
\Xhline{1pt}
\end{tabular}}}
\end{table}
...
\cline{2-3}\cline{4-5}\cline{6-7}\cline{8-9}
 ...
 & \makecell{\textbf{Avg gap}\\(\%)} & \makecell{\textbf{Avg time}\\(s)} \\
\hline
DeepACO & 1.55 & 7.91  & 3.45 & 75.66 & 0.97 & 9.44 & 1.98 & 64.16 \\
GFACS   & 1.48 & 7.88  & 2.51 & 77.52 & 0.84 & 9.40 & 0.60 & 71.37 \\
NeuFACO & \textbf{1.25} & \textbf{0.53} & \textbf{1.95} & \textbf{1.11} & \textbf{0.16} & \textbf{0.65} & 0.74 & \textbf{0.56} \\
\Xhline{1pt}
\end{tabular}
\endgroup
}}
...
& $N$ & \# & DeepACO & GFACS & \makecell{NeuFACO} \\
\hline
\multirow{2}{*}{\rotatebox[origin=c]{0}{\scalebox{0.8}{\makecell{TSPLib}}}} 
...
\Xhline{0.8pt}
\multirow{2}{*}{\rotatebox[origin=c]{0}{\scalebox{0.8}{\makecell{TSP \\ Random}}}}
& 200 & 10 & \makecell{1.77\% \\ 16.79s} & \makecell{1.67\% \\ 16.84s} & \textbf{\makecell{1.78\% \\ 0.31s}} \\
& 500 & 10 & \makecell{0.99\% \\ 118.45s} & \makecell{0.86\% \\ 140.87s} & \textbf{\makecell{0.96\% \\ 0.77s}} \\
\Xhline{1pt}
\end{tabular}}}
\end{table}
...
% Test Random
% TSP500 – NeuFACO → Avg gap: 0.96%, Avg time: 0.77s
% TSP200 – NeuFACO → Avg gap: 1.78%, Avg time: 0.31s
% TSP500 – GFACS → Avg gap: 0.86%, Avg time: 140.87s
% TSP200 – GFACS → Avg gap: 1.67%, Avg time: 16.84s
% TSP500 – DeepACO → Avg gap: 0.99%, Avg time: 118.45s
% TSP200 – DeepACO → Avg gap: 1.77%, Avg time: 16.79s

% Testlib
% TSPLib300-699 – NeuFACO → Avg gap: 2.06%, Avg time: 0.48s
% TSPLib100-299 – NeuFACO → Avg gap: 1.39%, Avg time: 0.22s
% TSPLib300-69 – GFACS → Avg gap: 2.46%, Avg time: 150.49s
% TSPLib100-299 – GFACS → Avg gap: 1.44%, Avg time: 13.75s
% TSPLib300-69 – DeepACO → Avg gap: 3.43%, Avg time: 143.92s
% TSPLib100-299 – DeepACO → Avg gap: 1.50%, Avg time: 13.70s
...
& 100--299 & 30 & \makecell{1.50\% \\ 13.70s} & \makecell{1.44\% \\ 13.75s} & \textbf{\makecell{1.39\% \\ 0.22s}} \\
& 300--699 & 10 & \makecell{3.43\% \\ 143.92s} & \makecell{2.46\% \\ 150.49s} & \textbf{\makecell{2.06\% \\ 0.48s}} \\
& 700--1499  & 12 & – & – & \textbf{\makecell{2.98\% \\ 1.03s}} \\
\Xhline{0.8pt}
\multirow{4}{*}{\rotatebox[origin=c]{0}{\scalebox{0.9}{\makecell{TSP \\ Random}}}}
& 200 & 128 & \makecell{1.01\% \\ 16.79s} & \makecell{0.92\% \\ 16.84s} & \textbf{\makecell{0.74\% \\ 0.31s}} \\
& 500 & 128 & \makecell{3.03\% \\ 118.45s} & \makecell{1.35\% \\ 140.87s} & \textbf{\makecell{1.50\% \\ 0.77s}} \\
& 1000 & 32 & \makecell{4.53\% \\ 652.46s} & \makecell{2.66\% \\ 731.17s} & \textbf{\makecell{2.12\% \\ 2.00s}} \\
\Xhline{1pt}
\end{tabular}}}
\end{table}
...
% Test Random
% TSPRandom200 – DeepACO → Avg gap: 1.01%, Avg time: 16.79s
% TSPRandom500 – DeepACO → Avg gap: 3.03%, Avg time: 118.45s
% TSPRandom1000 – DeepACO → Avg gap: 4.53%, Avg time: 652.46s
% TSPRandom200 – GFACS → Avg gap: 0.92%, Avg time: 16.84s
% TSPRandom500 – GFACS → Avg gap: 1.35%, Avg time: 140.87s
% TSPRandom1000 – GFACS → Avg gap: 2.66%, Avg time: 731.17s
% TSPRandom200 – PPOFACO → Avg gap: 0.74%, Avg time: 0.31s
% TSPRandom500 – PPOFACO → Avg gap: 1.50%, Avg time: 0.77s
% TSPRandom1000 – PPOFACO → Avg gap: 2.12%, Avg time: 2.00s
% Optimal Solution for TSP200 : 10.72, TSP500 : 16.55 and TSP1000 : 23.12

% Testlib
% TSPLib200 – DeepACO → Avg gap: 1.50%, Avg time: 13.70s
% TSPLib500 – DeepACO → Avg gap: 3.43%, Avg time: 143.92s
% TSPLib200 – GFACS → Avg gap: 1.44%, Avg time: 13.75s
% TSPLib500 – GFACS → Avg gap: 2.46%, Avg time: 150.49s
% TSPLib200 – PPOFACO → Avg gap: 1.39%, Avg time: 0.22s
% TSPLib500 – PPOFACO → Avg gap: 2.06%, Avg time: 0.48s
% TSPLib1000 – PPOFACO → Avg gap: 2.98%, Avg time: 1.03s
